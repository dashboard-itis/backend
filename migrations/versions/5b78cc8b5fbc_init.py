...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_privacy_policies_id'), 'privacy_policies', ['id'], unique=False
    )
    op.create_table(
        'streams',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            'role',
            sa.Enum('STUDENT', 'CURATOR', 'ADMIN', name='userrole'),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f('ix_import_sources_id'), 'import_sources', ['id'], unique=False
    )
    op.create_table(
        'grades',
        sa.Column('id', sa.Integer(), nullable=False),
